          ...
          for (var h = 0, f = e.length; h < f; h++) {
            ...
            g.key &&
              (g.key === a
                ...
                : !d.isPlainObject(g.key) || g.key.key !== a || (g.key.shiftKey && !b.shiftKey) || (g.key.altKey && !b.altKey) || (g.key.ctrlKey && !b.ctrlKey) || (g.key.metaKey && !b.metaKey) || ((b._buttonsHandled = !0), d(l).click()));
