	...
	records: [
		...
		},
		{
			...
			children: [
				...
				{
					value:
						"<a href='https://www.amschool.org' target='_blank'>amschool.org</a>",
					text_align: "left",
				},
				{
					value: "Education",
		...
		},
		{
			...
			children: [
				...
				{
					value:
						"<a href='https://www.anahuac.mx' target='_blank'>anahuac.mx</a>",
					text_align: "left",
				},
				{
		...
		},
		{
			...
			children: [
				...
				{
					value:
						"<a href='https://www.humboldt.ed.cr' target='_blank'>humboldt.ed.cr</a>",
					text_align: "left",
				},
				{
				...
				{
					value:
						"<div class='ellipsis_data add_ellipsis' >Airbus<br>Aer Lingus<br>",
					text_align: "left",
					html: "left",
				},
				{
					value:
						"<div class='ellipsis_data add_ellipsis' >Certified Community BH Clinic (CCBHC)<br>Accounting<br>Industry Week<br>401k Audit<br>Wealth Management<br>",
					text_align: "left",
				},
			],
		},
		{
			...
			children: [
				...
				{
					value:
						"<a href='https://www.saintmary.ed.cr' target='_blank'>saintmary.ed.cr</a>",
					text_align: "left",
				},
				{
					value: "Education > K-12 Schools",
				...
				{
					value:
						"<div class='ellipsis_data add_ellipsis' >Aer Lingus<br>Airbus<br>",
					text_align: "left",
					html: "left",
				},
				{
					value:
						"<div class='ellipsis_data add_ellipsis' >Accounting<br>401k Audit<br>",
					text_align: "left",
				},
			],
		},
